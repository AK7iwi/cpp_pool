...
/*   Updated: 2024/03/22 12:31:14 by mfeldman         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
std::ostream	&operator<<(std::ostream &os, Form &rhs) {
	os	<< "Form " 
		...
		<< "Bureaucrat need grade " << (int)rhs.get_grade_to_sign()
		<< " For sign it, and grade " << (int)rhs.get_grade_to_execute()
...
uint8_t Form::get_signed_status() const {return(_signed_status);}

uint8_t Form::get_grade_to_sign() const {return(_grade_to_sign);}

uint8_t Form::get_grade_to_execute() const {return(_grade_to_execute);}
...
std::string	Form::grade_too_high_exception::too_high() const throw() {return ("Form grade is too high");}

std::string	Form::grade_too_low_exception::too_low() const throw() {return ("Form grade is too low");}